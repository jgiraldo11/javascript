...
// Let's creat an array of objects -- something we will see very commonly

const courses = [
    {title: 'Softwear Engineering', type: 'full-time', weeks: 10}, //[0]
    {titile:'Game Dev', type:'part-time', weeks:3}, // [1]
